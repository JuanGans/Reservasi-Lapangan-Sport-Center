  ...
  return (
    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col px-6 py-8">
      ...
      <div className="flex items-center space-x-3 px-2 mb-6">
        ...
        />
        <div>
          {/* TASK 1: UBAH ADMIN DAN USER */}
          <p className="text-xs font-bold text-gray-900 leading-none mb-1">
            JTI Sport Center
            {/* ADMIN */}
            <span className="text-xs text-green-600 font-bold ml-2">Admin</span>
            {/* USER */}
            {/* <span className="text-xs text-green-600 font-bold ml-2">User</span> */}
          </p>
      ...
      {/* Buttons */}
      {/* TASK 2: BUAT TOMBOL BUTTON RESPONSIF */}
