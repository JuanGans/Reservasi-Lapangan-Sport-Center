  ...
  return (
    <div className="p-6 bg-white rounded-md shadow-sm">
      ...
      <div className="border rounded-md p-4 mb-6">
        <div className="flex justify-between items-center mb-2">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="font-semibold text-lg text-blue-900">{profileData.username}</h3>
      ...
      <div className="border rounded-md p-4">
        <h3 className="font-semibold text-blue-900 text-lg mb-2">Informasi Pribadi</h3>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">{profileData.no_hp}</p>
          </div>
        </div>
        <div className="flex justify-end mt-4">
          <button className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 cursor-pointer" onClick={openProfileModal}>
            Edit Profile
          </button>
        </div>
      </div>
