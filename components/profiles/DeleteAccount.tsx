  ...
  return (
    <div className="p-4 sm:p-6 bg-white rounded-md shadow-sm">
      ...
      <div className="flex justify-end">
        <button onClick={openDeleteModal} className="bg-red-500 text-white px-4 py-2 text-sm sm:text-base rounded-md hover:bg-red-600 transition duration-200 cursor-pointer">
          Hapus Akun
        </button>
      </div>
    </div>
